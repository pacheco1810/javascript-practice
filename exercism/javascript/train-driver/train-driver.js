...
export function fixListOfWagons(ids) {
  const [firstWagon, secondWagon, ...restWagons] = ids;
  return [...restWagons, firstWagon, secondWagon];
}
...
export function correctListOfWagons(ids, missingWagons) {
  const [firstWagons, ...restWagons] = ids;
  return [firstWagons, ...missingWagons, ...restWagons];
}
